...
class CILogViewer {
     ...
     */
    private static $API_QUERY_PARAM;
    private static $API_FILE_QUERY_PARAM;
    private static $API_LOG_STYLE_QUERY_PARAM;
    private static $API_CMD_LIST;
    private static $API_CMD_VIEW;
    private static $API_CMD_DELETE;


    public function __construct() {
		$this->LOG_DATE_PATTERN= array("/^((ERROR)|(INFO)|(DEBUG)|(ALL))\s\-\s/", "/\s(-->)/");
		self::$API_QUERY_PARAM = "api";
		self::$API_FILE_QUERY_PARAM = "f";
		self::$API_LOG_STYLE_QUERY_PARAM = "sline";
		self::$API_CMD_LIST = "list";
		self::$API_CMD_VIEW = "view";
		self::$API_CMD_DELETE = "delete";
        $this->init();
    }
